...
export class SocialShare {
  ...
  // Alias: modal dispatch derives method names as shareTo<Platform>, so the
  // Email button resolves to shareToEmail.
  shareToEmail(data) { return this.shareViaEmail(data); }
